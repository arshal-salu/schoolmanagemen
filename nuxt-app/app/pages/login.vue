  ...
  <div>
    ...
    <div class="mb-6">
      <button
        ...
        :disabled="loading"
        class="w-full py-3 px-4 bg-slate-900 hover:bg-slate-800 active:bg-slate-950 border border-slate-700/80 text-white rounded-xl font-semibold text-sm flex items-center justify-center gap-3 transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed group"
      >
        <svg class="w-5 h-5 transition-transform group-hover:scale-105" viewBox="0 0 24 24">
      ...
      <div class="relative my-5 text-center">
        ...
        <span class="relative bg-slate-900 px-3 text-[11px] text-slate-400 uppercase tracking-widest font-bold rounded-full">Or continue with email</span>
      </div>
    </div>
...
const handleGoogleLogin = async () => {
  ...
  try {
    ...
    errorMessage.value = 'Failed to initialize Google login. Please try again.'
